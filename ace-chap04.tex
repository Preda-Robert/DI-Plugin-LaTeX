...
This chapter documents host data structures, the workspace aggregation algorithm, each contributed command workflow, diagnostic and code-action behavior, design heuristics, and limitations. Empirical outcomes appear in Chapter~\ref{chap5:evaluation}.
